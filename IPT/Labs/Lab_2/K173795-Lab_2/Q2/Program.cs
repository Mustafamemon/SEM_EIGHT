...
namespace Q2
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Program woThread = new Program(random_array, 0, 1000000, number);
            ...
            searchIndexes(woThread);

            stopwatch.Stop(); // timmer stop

            TimeSpan ts_without_thread = stopwatch.Elapsed;
            ...
            Console.WriteLine("\nElapsed Time is {0} ms", ts_without_thread.Milliseconds);

            Console.WriteLine("Elapsed Time is {0} ms", ts_with_thread.Milliseconds);
